        ...
        <div className="terms-content">
          {activeTab === 'overview' ? (
            <div className="policy-content">
              <h2>Overview</h2>
              <p>This website is operated by R DESIIGN INC. Throughout the site, the terms "we", "us" and "our" refer to R DESIIGN INC. RDESIIGN INC offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
            ...
            <div className="policy-content">
              ...
              <p>You agree to indemnify, defend and hold harmless R DESIIGN INC and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of your breach of these Terms of Service.</p>
              ...
              <p>These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of India and jurisdiction of Faridabad, Haryana.</p>

              <h3>SECTION 19 - CHANGES TO TERMS OF SERVICE</h3>
              <p>You can review the most current version of the Terms of Service at any time at this page.</p>

              <h3>SECTION 20 - CONTACT INFORMATION</h3>
              <p>Questions about the Terms of Service should be sent to us at email@rdesiigninc.in.</p>
            </div>
          )}
        </div>
      </div>
